...
export default async function handler(req, res) {
  ...
  try {
    ...
    await pool.query(
      'INSERT INTO users (ucp_name, password, discord_id, ip_address) VALUES ($1, $2, $3, $4)',
      [ucp_name, hashedPassword, discordId, ip_address]
    );
    ...
    if (error.code === '23505') { // Kode error duplikat untuk PostgreSQL
        return res.status(409).json({ message: 'Nama UCP atau Akun Discord sudah digunakan.' });
    }
